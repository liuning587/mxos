	...
	else
	{
		...
		#if ( configGENERATE_RUN_TIME_STATS == 1 )
		{
		    unsigned long ulTempCounter;
				...
				if( ulTempCounter > ulTaskSwitchedInTime )
				{
...
void vApplicationStackOverflowHook( xTaskHandle xTask, signed char *pcTaskName )
{
    ...
    vTaskSuspend((xTaskHandle)xTask);
}
	...
	unsigned short usStackRemaining;
	    ...
	    do
	    {
	        ...
	        #if ( portSTACK_GROWTH > 0 )
	        {
	            usStackRemaining = prvTaskCheckFreeStackSpace( ( unsigned char * ) pxNextTCB->pxEndOfStack );
	        }
	        #else
	        {
	            usStackRemaining = prvTaskCheckFreeStackSpace( ( unsigned char * ) pxNextTCB->pxStack );
	        }
	        #endif
